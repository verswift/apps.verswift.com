...
function fetchBookmarks()
{
  ...
  for(var i = 0; i < bookmarks.length; i++)
  {
    ...
    //    bookmarksResults.innerHTML += '<div class="col-md-6 col-xl-3 mb-4" style="width: 100%">' +


    bookmarksResults.innerHTML += '<div class="col-auto" style="width: 350px">' +
    // for random colours 
        ...
        '<div class="card shadow-sm border-left-primary py-2">' +
            '<div class="card-body">' +
                '<div class="row align-items-center no-gutters">' +
                    ...
                    '<div class="col mr-2">' +
                        '<div class="text-dark d-xl-flex justify-content-xl-center align-items-xl-center font-weight-bold h5 mb-0"><span class="text-center d-flex d-xl-flex justify-content-center align-items-center justify-content-xl-center align-items-xl-center" style="font-size: 15px; word-break: break-all">'
                        +name+'</span></div>' +
                    '</div>' +
